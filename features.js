...
const features = [
    ...
    resources: [
      {
        ...
        url: "https://www.php.net/releases/8.5/en.php#pipe-operator",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/pipe-operator-v3" },
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/pipe-operator",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/pipe-operator-in-php-85",
      },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/the-pipe-operator-is-coming-to-php-85",
      },
    ],
  },
  {
    name: "array_first()",
    description:
      "Returns the first value of an array. If the array is empty, `null` is returned (making it easy to compose with the `??` operator).",
    keywords: ["arrays"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-first.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_first_last" },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/native-array-first-and-array-last-functions-in-php-85",
      },
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/array_first-array_last",
      },
    ],
  },
  {
    name: "array_last()",
    description:
      "Returns the last value of an array. If the array is empty, `null` is returned (making it easy to compose with the `??` operator).",
    keywords: ["arrays"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-last.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_first_last" },
      {
        name: "Laravel News",
  ...
  },
  {
    ...
    keywords: ["url", "uri", "addresses", "extensions"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Release Notes",
        url: "https://www.php.net/releases/8.5/en.php#new-uri-extension",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/url_parsing_api" },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/php-85-introduces-a-new-uri-extension",
      },
    ],
  },
  {
    ...
    description:
      "Allow closures to be aliased to a variable that can be used within the closure, allowing self-reference and recursion.",
    keywords: ["closures", "recursion", "functions"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/closure_self_reference",
      },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/retrieve-the-currently-executing-closure-in-php-85",
      },
    ],
  },
  {
    name: "Fatal Error Backtraces through fatal_error_backtraces settings",
    description: "",
    keywords: ["settings", "errors", "debugging"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/error_backtraces_v2" },
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/fatal_error_backtraces",
      },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/php-fatal-error-backtraces-in-php-85",
      },
    ],
  },
  {
    name: "--ini=diff command-line option",
    description:
      "Lists INI directives that differ from the built-in default values",
    keywords: ["cli", "commandline", "diff", "ini", "settings"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "Laravel News",
        url: "https://laravel-news.com/php-85-introduces-an-ini-diff-option",
      },
      { name: "PHP.Watch", url: "https://php.watch/versions/8.5/cli-ini-diff" },
    ],
  },
  {
    name: "Closures and callables in constant expressions",
    description:
    ...
    resources: [
      {
        name: "PHP Release Notes",
        url: "https://www.php.net/releases/8.5/en.php#closures-in-const-expr",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/closures_in_const_expr",
      },
      {
        name: "Laravel News",
        url: "https://laravel-news.com/support-closures-in-constant-expressions-in-php-8-5",
      },
    ],
  },
  {
    ...
    description:
      "Returns an array of `CurlHandle` objects from a `CurlMultiHandle` object.",
    keywords: ["curl"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/curl_multi_get_handles",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Release Notes",
        url: "https://www.php.net/releases/8.5/en.php#clone-with",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/clone_with_v2" },
    ],
  },
  {
    name: "Persistent cURL Share Handles - curl_share_init_persistent()",
    description:
    ...
    resources: [
      {
        name: "PHP Release Notes",
        url: "https://www.php.net/releases/8.5/en.php#persistent-curl-share-handles",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/curl_share_persistence",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/curl_share_persistence_improvement",
      },
    ],
  },
  {
    name: "PHP_BUILD_PROVIDER constant",
    description:
      "Contains the PHP_BUILD_PROVIDER environment variable set at build time.",
    keywords: ["constants"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/PHP_BUILD_PROVIDER",
      },
    ],
  },
  {
    name: "PHP_BUILD_DATE constant",
    description: "Contains the time and date the PHP binary is built",
    keywords: ["constants"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/PHP_BUILD_DATE",
      },
    ],
  },
  {
    name: "get_error_handler()",
    description: "Gets the user-defined error handler function.",
    keywords: ["errors", "functions"],
    added: "8.5",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.get-error-handler.php",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/get-error-exception-handler",
      },
      {
        name: "PHP.Watch",
        url: "https://php.watch/versions/8.5/get_error_handler-get_exception_handler",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.get-exception-handler.php",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/get-error-exception-handler",
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.property-hooks",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/property-hooks" },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#property-hooks-rfc",
      },
      {
        name: "Ash Allen Design Blog",
        url: "https://ashallendesign.co.uk/blog/php-84-property-hooks",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.asymmetric-property-visibility",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/asymmetric-visibility-v2",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#asymmetric-visibility-rfc",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.lazy-objects",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/lazy-objects" },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#lazy-objects-rfc",
      },
    ],
  },
  {
    ...
    description:
      "The new Deprecated attribute can be used to mark functions, methods, and class constants as deprecated.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.deprecated-attribute",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.rfc1867",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/request_parse_body",
      },
    ],
  },
  {
    ...
    description:
      "New expressions with constructor arguments now allow chaining method calls, property accesses, etc. without enclosing the expression in parentheses.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.new-chaining",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#new-without-parentheses-rfc",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-with-parentheses-php-84",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/new_without_parentheses",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.debug-weakref",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.debug-closure",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.core.multiple-namespaces-symbols",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.curl",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/curl_version-feature_list",
      },
    ],
  },
  {
    ...
    description:
      "Added `CURL_HTTP_VERSION_3` and `CURL_HTTP_VERSION_3ONLY` constants as available options for `CURLOPT_HTTP_VERSION`.",
    keywords: ["http3", "quic"],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      ...
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/CURL_HTTP_VERSION_3-CURL_HTTP_VERSION_3ONLY",
      },
    ],
  },
  {
    ...
    description:
      "Added `CURLOPT_PREREQFUNCTION` as a cURL option that accepts a callable to be called after the connection is made, but before the request is sent",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    description:
      "Added `CURLOPT_DEBUGFUNCTION` as a cURL option that accepts a callable that gets called during the request lifetime.",
    keywords: ["debugging"],
    added: "8.4",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/CURLOPT_BINARYTRANSFER-deprecated",
      },
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.deprecated.php#migration84.deprecated.core.curl",
      },
    ],
  },
  {
    name: "Dom namespace",
    description:
      "Added the `Dom` namespace with new classes as counterparts to the existing `DOM` classes (e.g. `DomNode` is the new `DOMNode`). These classes are compatible with HTML 5 and are WHATWG spec-compliant.",
    keywords: ["HTML5"],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.dom",
      },
    ],
  },
  {
    ...
    description:
      "`DOMNode::compareDocumentPosition()` with its associated constants",
    keywords: ["HTML"],
    added: "8.4",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.intl",
      },
    ],
  },
  {
    ...
    description:
      "Added support for Curve25519 + Curve448 based keys. Specifically x25519, ed25519, x448 and ed448 fields are supported.",
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.openssl",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "The bundled pcre2lib has been updated, enabling new patterns and modifiers.",
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.pcre",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/pcre2-regexp-syntax-changes",
      },
    ],
  },
  {
    ...
    description:
      "Multiple new methods and constants which are related to the lazy objects feature have been added, plus other small additions.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-features.php#migration84.new-features.reflection",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-functions.php#migration84.new-functions.bcmath",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/datetime-createFromTimestamp",
      },
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-functions.php#migration84.new-functions.date",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/date-datetime-get-setMicrosecond",
      },
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-functions.php#migration84.new-functions.date",
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/domxpath.quote.php",
      },
    ],
  },
  {
    ...
    description:
      "The Intl extension in PHP 8.4 provides a new function named `intltz_get_iana_id` and a new static method `IntlTimeZone::getIanaID()` that returns the IANA time zone ID for a given timezone identifier.",
    keywords: ["internationalization", "localization", "i18n", "formatting"],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/intltz_get_iana_id-IntlTimeZone-getCanonicalID",
      },
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.new-functions.php#migration84.new-functions.intl",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Split a string into an array with support for grapheme cluster byte characters.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.grapheme-str-split.php",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/grapheme_str_split",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.mb-ucfirst.php",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/mb_ucfirst-mb_ucfirst",
      },
    ],
  },
  {
  ...
  },
  {
    name: "mb_rtrim()",
    description:
      "Strip whitespace (or other characters) from the end of a string (multi-byte safe).",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.mb-rtrim.php",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/mb_trim-mb_ltrim-mb_rtrim",
      },
    ],
  },
  {
    name: "mb_ltrim()",
    description:
      "Strip whitespace (or other characters) from the beginning of a string (multi-byte safe).",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.mb-ltrim.php",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/mb_trim-mb_ltrim-mb_rtrim",
  ...
  },
  {
    name: "mb_trim()",
    description:
      "Strip whitespace (or other characters) from the beginning and end of a string (multi-byte safe).",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.mb-trim.php",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/mb_trim-mb_ltrim-mb_rtrim",
  ...
  },
  {
    ...
    description:
      "PHP 8.4 adds the function `http_get_last_response_headers` that gets the HTTP headers of the last HTTP wrapper response. This can replace the historical `$http_response_header` variable.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/http_get-clear_last_response_headers",
      },
    ],
  },
  {
    ...
    description:
      "PHP 8.4 adds the function `http_clear_last_response_headers` that clears the HTTP headers of the last HTTP wrapper response. This can replace the historical `$http_response_header` variable.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-all.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_find" },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/array_find-array_find_key-array_any-array_all",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#array_find-rfc",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-any.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_find" },
      {
        name: "PHP Watch",
  ...
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-find.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_find" },
      {
        name: "PHP Watch",
      ...
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/array-find-in-php-84",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/function.array-find-key.php",
      },
      { name: "PHP RFC", url: "https://wiki.php.net/rfc/array_find" },
      {
        name: "PHP Watch",
  ...
  },
  {
    ...
    description:
      "A typed variable with a default null value would be made nullable automatically - this behaviour is now deprecated and will be removed in PHP 9.",
    keywords: [],
    added: "5.6",
    deprecated: "8.4",
    removed: null,
    resources: [
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#implicit-nullable-types-deprecation",
      },
      {
        name: "PHP RFC",
        url: "https://wiki.php.net/rfc/deprecate-implicitly-nullable-types",
      },
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/implicitly-marking-parameter-type-nullable-deprecated",
      },
      {
        name: "PHP Manual",
        url: "https://www.php.net/manual/en/migration84.deprecated.php#migration84.deprecated.core.implicitly-nullable-parameter",
      },
    ],
  },
  {
    ...
    description:
      "PHP 8.4 adds a `DomHTMLDocument` class which is able to parse HTML5 code properly. The old `DOMDocument` class is still available for backwards compatibility.",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      ...
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#new-html5-support-rfc",
      },
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/html-5-in-php-84",
      },
    ],
  },
  {
    name: "JIT changes",
    description:
      "PHP 8.4 changes the way the JIT is enabled to use `opcache.jit=disable`",
    keywords: [],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      ...
      {
        name: "Stitcher.io Blog",
        url: "https://stitcher.io/blog/new-in-php-84#jit-changes-rfc",
      },
    ],
  },
  {
    ...
    description:
      "The Sodium extension in PHP 8.4 supports AEGIS-128L and AEGIS256 encryption algorithms if the Sodium extension is compiled with libsodium 1.0.19 or later.",
    keywords: ["security", "encryption", "cryptography"],
    added: "8.4",
    deprecated: null,
    removed: null,
    resources: [
      {
        name: "PHP Watch",
        url: "https://php.watch/versions/8.4/sodium-aegis-encryption-support",
      },
    ],
  },
  {
    name: "str_increment",
    description: "Increment an alphanumeric string.",
  ...
  {
    name: "mb_str_pad",
    description: "The mbstring equivalent of `str_pad`.",
  ...
  },
  {
    ...
    description: "Anonymous classes can now be marked as readonly.",
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: "Random extension: New RandomRandomizer::getFloat() and nextFloat() methods - PHP.Watch",
  ...
  },
  {
    ...
    description: "Generate a random float value.",
    keywords: ["random", "randomizer", "floats", "numbers"],
    added: "8.3",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: "Random extension: New RandomRandomizer::getBytesFromString method - PHP.Watch",
  ...
  },
  {
    ...
    description: "Gets the cipher key length",
  ...
  },
  {
    ...
    description: "Get a file handler to the entry defined by its name.",
  ...
  },
  {
    ...
    description: "Get a file handler to the entry defined by its index.",
    keywords: ["zip", "streams"],
    added: "8.2",
    deprecated: null,
    removed: null,
  ...
  },
  {
    ...
    description: "You can now use constants in traits.",
  ...
  },
  {
    ...
    keywords: ["xxhash", "hash", "functions", "performance"],
    added: "8.1",
    deprecated: null,
    removed: null,
    resources: [
  ...
  },
  {
    ...
    description: `Nullsafe operator allows you to access properties and methods of nullable objects.
  ...
  },
  {
    ...
    description: `Arrow functions are a shorthand for anonymous functions:
  ...
  },
  {
    ...
    description: "Argon2 has been added to the password hashing API</li>",
  ...
  },
  {
    ...
    description:
      "The Intl extension has deprecated the INTL_IDNA_VARIANT_2003 variant, which is currently being used as the default for idn_to_ascii() and idn_to_utf8().",
    keywords: [
      "constants",
      "deprecated",
      "removed",
  ...
  },
  {
    ...
    description: `Filtered unserialize allows developers to specify which classes they expect data to unserialize into.
  ...
  },
  {
    ...
    description:
      "A right associative <code>**</code> operator has been added to support exponentiation, along with a <code>**=</code> shorthand assignment operator.",
    keywords: [
      "exponent",
      "exponentiation",
      "power",
  ...
  },
  {
    ...
    description:
      '`"${foo}"` is deprecated in PHP 8.2; `"{$foo}"` is still allowed.',
  ...
  },
  {
    ...
    description:
      "deprecate callables that are supported by `call_user_func($callable)`, but not by `$callable()` - read the resources!",
    keywords: [],
    added: "0.0",
    deprecated: "8.2",
    removed: "9.0",
  ...
  },
  {
    ...
    description:
      "utf8_encode and utf8_decode Functions Deprecated - The RFC suggests using mb_convert_encoding() instead.",
